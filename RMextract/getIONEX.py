...
def getTECinterpol(time,lat,lon,tecinfo,apply_earth_rotation=False):
    ...
    #now get all needed maps
        ...
        print tecdata[timeIdx1,lat1,lon11], \
              tecdata[timeIdx2,lat1,lon21], \
              tecdata[timeIdx1,lat1,lon12], \
              tecdata[timeIdx2,lat1,lon22], \
              tecdata[timeIdx1,lat2,lon11], \
              tecdata[timeIdx2,lat2,lon21], \
              tecdata[timeIdx1,lat2,lon12], \
              tecdata[timeIdx2,lat2,lon22]
